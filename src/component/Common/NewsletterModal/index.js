...
import img from '../../../assets/img/gracery/product10.jpg'
                                    ...
                                    <div className="row">
                                        <div className="col-lg-7 col-md-6">
                                            <div className="offer_modal_left">
                                                ...
                                                <p>Subscribe to the Vasantham mailing list to receive updates
                                                    on new arrivals, special offers and our promotions.</p>
                                                <form onSubmit={(e) => {e.preventDefault();props.stop();props.start()}}>
                                                    <div className="input-group mb-3">
                                                        <input type="email" className="form-control modal_input" placeholder="Your Email address" required />
