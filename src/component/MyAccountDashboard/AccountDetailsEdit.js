...
const AccountDetailsEdit = (props) => {
  ...
  const Submit = (e) => {
    ...
    if (UserDetail.new_password === UserDetail.confirm_pass) {
      dispatch(
        ProfileUpdate(UserDetail, getImage != "" ? upload : getImage)
      ).then((res) => {
        setloading(false);
              ...
              <div className="account_thumb_img">
                <div>
                  ...
                  <div className="fixed_icon">
                    <input type="file" onChange={OnUplodFileChange} />
                ...
                <div className="row">
                  <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                    <div className="form-group">
                      <label htmlFor="f_name" className="h6">
                        First Name
                      </label>
                      <input
                        type="text"
                        ...
                        id="f_name"
                        required
                        value={UserDetail.f_name}
                        onChange={(data) =>
                          onChangeData(data.target.value, "f_name")
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        className="form-control"
                        required
                        value={UserDetail.l_name}
                        onChange={(data) =>
                          onChangeData(data.target.value, "l_name")
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                    <div className="form-group">
                      <label htmlFor="email_address" className="h6">
                        Email
                      </label>
                      <input
                        type="email"
                        ...
                        onChange={(data) =>
                          onChangeData(data.target.value, "email")
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                    <div className="form-group">
                      <label htmlFor="current_password" className="h6">
                        Password
                      </label>
                      <input
                        type="password"
                        ...
                        onChange={(data) =>
                          onChangeData(data.target.value, "new_password")
                        }
                      />
                    </div>
                  </div>
                  <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        minLength={6}
                        id="re_password"
                        required={UserDetail.new_password !== "" && true}
                        value={UserDetail.confirm_pass}
                        onChange={(data) =>
                          onChangeData(data.target.value, "confirm_pass")
                        }
                      />
                      <div
                        style={{
